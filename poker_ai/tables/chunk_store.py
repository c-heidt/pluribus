...
:class:`~poker_ai.tables.checkpoint.CheckpointManager`.
...
Higher layers (:class:`~poker_ai.tables.chunked_table.ChunkedTable`,
:class:`~poker_ai.tables.cfr_tables.CFRTables`) assign semantics.
...
class ChunkStore:
    ...
    def _save(self, dir_path: Path, n_entries: int, prefix: str, dirty_only: bool) -> int:
        ...
        disk via :func:`utils.io.atomic_numpy_save`.
        """
