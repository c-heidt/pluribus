...
dispatched by the :class:`~poker_ai.ai.multiprocess.server.Server`.
All per-traversal training logic lives in
:mod:`poker_ai.ai.training`; this class is a thin dispatch loop
...
class Worker(mp.Process):
    ...
    def _flush_delta(self) -> None:
        ...
        :func:`poker_ai.ai.cfr.merge_local_delta`, which internally
