...
class TestFullDeckSpecifics:
    ...
    def test_full_deck_has_52_cards(self):
        ...
        state = new_game(n_players=2, card_info_lut={}, low_card_rank=2, high_card_rank=14)
    ...
    def test_full_deck_includes_low_cards(self):
        ...
        state = new_game(n_players=6, card_info_lut={}, low_card_rank=2, high_card_rank=14)  # Max players
    ...
    def test_full_deck_vs_short_deck_differences(self):
        ...
        full_deck_state = new_game(n_players=2, card_info_lut={}, low_card_rank=2, high_card_rank=14)

        short_deck_state = new_game(n_players=2, card_info_lut={}, low_card_rank=10, high_card_rank=14)
...
class TestFullDeckCardRange:
    ...
    def test_all_ranks_can_appear(self):
        ...
        for _ in range(20):
            state = new_game(n_players=6, card_info_lut={}, low_card_rank=2, high_card_rank=14)
...
class TestFullDeckActionSequences:
    ...
    def test_all_call_sequence(self, n_players):
        ...
        state = new_game(n_players=n_players, card_info_lut={}, low_card_rank=2, high_card_rank=14)
...
class TestFullDeckPreFlopPot:
    ...
    def test_pre_flop_pot(self, n_players: int, small_blind: int, big_blind: int):
        ...
        pot = Pot()
        players = [
            Player(player_i=i, pot=pot, initial_chips=10000)
